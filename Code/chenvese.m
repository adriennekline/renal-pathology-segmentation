...
function seg = chenvese(I,mask,num_iter,mu,method,x_position,y_position, glom_radius_proportion)
...
%   auto mask settings
  if ischar(mask)
      switch lower (mask)
          ...
          case 'medium'
              mask = maskcircle2(I,'medium',x_position, y_position, glom_radius_proportion);
          case 'large'
